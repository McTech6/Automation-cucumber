...
public class LoggedInPage extends BrowserDriver {
    ...
    public static String productcateogry_sportsshoes = "//*[text()='InvalidSports']"; // Error: Invalid XPath
    ...
    public static void visibility_productcategory_sportsshoes() throws InterruptedException {
        // This will throw NoSuchElementException because of invalid XPath
